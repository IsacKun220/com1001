...
Note that we do not give instructions on how to use on the student's machine. We encourage everything to be run on Codio. Here are some alternatives.... REWRITE THE FOLLOWING:
...
# Which Code Examples are Discussed in Which Lectures?
